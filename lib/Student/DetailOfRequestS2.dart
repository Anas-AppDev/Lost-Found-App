...
class DetailOfRequestS2 extends StatefulWidget {

  String pid;
  DetailOfRequestS2({super.key, required this.pid});

  @override
  State<DetailOfRequestS2> createState() => _DetailOfRequestS2State();
}

class _DetailOfRequestS2State extends State<DetailOfRequestS2> {
                        ...
                        itemBuilder: (context, index){
                          ...
                          return Column(
                            ...
                            children: [
                              ...
                              Text("Pending", style: TextStyle(fontFamily: "Poppins", fontWeight: FontWeight.bold, color: Colors.white, fontSize: 40, height: 1.2),),
                        ...
                        itemBuilder: (context, index){
                          ...
                          return Column(
                            ...
                            children: [
                              SizedBox(height: 30,),
                              Text("Pending", style: TextStyle(fontFamily: "Poppins", fontWeight: FontWeight.bold, color: Colors.white, fontSize: 40, height: 1.2),),
                              Text("Request", style: TextStyle(fontFamily: "Poppins", fontWeight: FontWeight.bold, color: Colors.white, fontSize: 40, height: 1.2),),
                        ...
                        itemBuilder: (context, index){
                          ...
                          return Column(
                            ...
                            children: [
                              SizedBox(height: 30,),
                              Text("Claim", style: TextStyle(fontFamily: "Poppins", fontWeight: FontWeight.bold, color: Colors.white, fontSize: 40, height: 1.2),),
                              Text("Accepted", style: TextStyle(fontFamily: "Poppins", fontWeight: FontWeight.bold, color: Colors.white, fontSize: 40, height: 1.2),),
