...
class RequestItemS2 extends StatefulWidget {

  RequestItemS2({super.key});


  @override
  State<RequestItemS2> createState() => _RequestItemS2State();
}

class _RequestItemS2State extends State<RequestItemS2> {
                          ...
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                SizedBox(width: 15,),
                                Expanded(
                                  child: AutoDropdown(ctrl: iTypeCtrl, list: typesList, listSelected: typeListSelected, widths: 135, hint: "Type",)
                                ),
                              ],
                            ),
                          ),
