...
class NavDrawerS2 extends StatefulWidget {
  const NavDrawerS2({super.key});

  @override
  State<NavDrawerS2> createState() => _NavDrawerS2State();
}

class _NavDrawerS2State extends State<NavDrawerS2> {
                  ...
                  DrawerHeader(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 10,),
                          Text("Shruti Saini", style: TextStyle(fontFamily: "Poppins", fontWeight: FontWeight.bold, color: Colors.white, fontSize: 15, height: 1.2),),
                          Text("21BCS9026", style: TextStyle(fontFamily: "Poppins", fontWeight: FontWeight.normal, color: Colors.white, fontSize: 11,),),
