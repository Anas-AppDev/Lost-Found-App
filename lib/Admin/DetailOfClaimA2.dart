...
class DetailOfClaimA2 extends StatefulWidget {

  String studUid, pid, iName, iType;
  DetailOfClaimA2({super.key, required this.pid, required this.studUid, required this.iName, required this.iType});

  @override
  State<DetailOfClaimA2> createState() => _DetailOfClaimA2State();
}

class _DetailOfClaimA2State extends State<DetailOfClaimA2> {
